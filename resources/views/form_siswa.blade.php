                ...
                <form>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="nama" placeholder="Tempat Kelahiran">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="dob">Tanggal</label>
                            <input type="date" class="form-control" id="tgl" placeholder="Tanggal Kelahiran">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="hobby" placeholder="Hobby Anda">
                    </div>
                    <div class="form-group">
                      <label for="inputAddress2">Alamat</label>
                      <input type="text" class="form-control" id="alamat" placeholder="Apartment, studio, or floor">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
